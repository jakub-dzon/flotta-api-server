...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (ed *EdgeDevice) DeepCopyInto(out *EdgeDevice) {
	*out = *ed
	out.TypeMeta = ed.TypeMeta
	ed.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	ed.Spec.DeepCopyInto(&out.Spec)
	ed.Status.DeepCopyInto(&out.Status)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EdgeDevice.
func (ed *EdgeDevice) DeepCopy() *EdgeDevice {
	if ed == nil {
		return nil
	}
	out := new(EdgeDevice)
...
func (ed *EdgeDevice) DeepCopyObject() runtime.Object {
	if c := ed.DeepCopy(); c != nil {
		return c
	}
	return nil
}
