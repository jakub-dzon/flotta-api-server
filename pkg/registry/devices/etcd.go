...
import (
	...
	"github.com/programming-kubernetes/pizza-apiserver/pkg/apis/v1alpha1"
...
func NewREST(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (*registry.REST, error) {
	...
	store := &genericregistry.Store{
		...
		DefaultQualifiedResource: restaurant.Resource("edgedevices"),

		CreateStrategy: strategy,
		UpdateStrategy: strategy,
		DeleteStrategy: strategy,

		TableConvertor: rest.NewDefaultTableConvertor(restaurant.Resource("edgedevices")),
	}
